...
route(Departing, Arriving, Visited, DepartureTime, ArrivalTime, Flights, TotalCost) :-
  ...
  .
% find other route search
route(Departing, Arriving, Visited, DepartureTime, ArrivalTime, Flights, TotalCost) :-
  flight(Departing, Transfer, DepartureTime, TransferArrival, InitCost),
  \+ member(Transfer, Visited),
  append(Visited, [Departing, Transfer], NewVisited), 
  route(Transfer, Arriving, NewVisited, TransferDeparture, ArrivalTime, TailFlights, TailCost), % remaining of the flight path
